...
class Tile extends StatelessWidget {
  ...
  const Tile({this.id, this.size, this.onClick});
...
class TileRow extends StatelessWidget {
  ...
  const TileRow({this.ids, this.width, this.onClick});
...
typedef RowColumnCallback(int row, int column);
